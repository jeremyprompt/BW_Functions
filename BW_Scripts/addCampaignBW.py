...
# Action "AS_SPECIFIED" with campaignId specifies add/assign campaign
payload = {
    ...
    "tnOptionGroups": [
        {
            ...
            "a2pSettings": {
                "action": "AS_SPECIFIED",  # specifies add campaign
                "campaignId": "CVZJ1EL"
            },
            "phoneNumbers": [
                "+12549465498",
...
if response.status_code == 201:
    print("✓ Campaign addition order created successfully!")
